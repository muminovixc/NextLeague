          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-[#6ba3be] text-xl">
                ...
                manage successful sports leagues and clubs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {[
                ...
                <div
                  key={i}
                  className="bg-[#031716] p-8 rounded-lg border border-[#0c969c]/20"
                >
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-[#6ba3be] text-xl mb-8">
                  Get detailed analytics on player performance, team statistics,
                  and league trends to make informed decisions.
                </p>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-[#6ba3be]">
                    <svg
                      className="w-5 h-5 mr-3 text-[#0c969c]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
